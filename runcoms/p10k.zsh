# Generated by Powerlevel10k configuration wizard on 2025-06-25 at 15:40 CDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_UNSTAGED_DELETED )) && res+=" ${modified}󰆴 ${VCS_STATUS_NUM_UNSTAGED_DELETED}"
    (( VCS_STATUS_NUM_STAGED_DELETED   )) && res+=" ${modified}󰗨 ${VCS_STATUS_NUM_STAGED_DELETED}"
    (( VCS_STATUS_NUM_UNSTAGED         )) && res+=" ${modified}✱${VCS_STATUS_NUM_UNSTAGED}"
    (( VCS_STATUS_NUM_UNMERGED         )) && res+=" ${modified}=${VCS_STATUS_NUM_UNMERGED}"
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_THRESHOLD=3600 # one hour
